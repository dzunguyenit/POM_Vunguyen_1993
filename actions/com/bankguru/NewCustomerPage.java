...
public class NewCustomerPage extends AbstractPage {
	...
	public void inputCustomerName(String customerName) {
		...
		highlightElement(driver, CustomerPageUI.CUSTOMERNAME_TXT);
	...
	public void inputDateOfBirth(String dateOfBirth) {
		...
		highlightElement(driver, CustomerPageUI.DATEOFBIRTH_TXT);
	...
	public void inputMobileNumber(String mobileNumber) {
		...
		highlightElement(driver, CustomerPageUI.MOBILENUMBER_TXT);
	...
	public String getTextMessageCreateCustomerSucces() {
		...
		highlightElement(driver, CustomerPageUI.REGISTERSUCCESS_LBL);
	...
	public String getTextUserID() {
		...
		highlightElement(driver, CustomerPageUI.CUSTOMERID_LBL);
	...
	public String getTextUsernameErr() {
		...
		highlightElement(driver, CustomerPageUI.CUSTOMERNAME_ERRORMSG);
	...
	public String getTextAddressErr() {
		...
		highlightElement(driver, CustomerPageUI.ADDRESS_ERRORMSG);
	...
	public String getTextCityErr() {
		...
		highlightElement(driver, CustomerPageUI.CITY_ERRORMSG);
	...
	public String getTextStateErr() {
		...
		highlightElement(driver, CustomerPageUI.STATE_ERRORMSG);
	...
	public String getTextPinErr() {
		...
		highlightElement(driver, CustomerPageUI.PIN_ERRORMSG);
	...
	public String getTextTelePhoneErr() {
		...
		highlightElement(driver, CustomerPageUI.TELEPHONE_ERRORMSG);
	...
	public String getTextEmailErr() {
		...
		highlightElement(driver, CustomerPageUI.EMAIL_ERRORMSG);
